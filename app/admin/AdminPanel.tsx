...
const pageFieldSchemas: Record<string, PageFieldSpec[]> = {
  ...
  contacts: [
    ...
    { key: "requisitesHeading", label: "Заголовок блока реквизитов" },
    { key: "companyLegalName", label: "Полное наименование организации" },
    { key: "legalAddress", label: "Юридический адрес", multiline: true },
    { key: "postalAddress", label: "Почтовый адрес", multiline: true },
    { key: "inn", label: "ИНН" },
    { key: "kpp", label: "КПП" },
    ...
    { key: "bik", label: "БИК" },
    { key: "requisitesNote", label: "Дополнительная информация", multiline: true },
  ],
};
